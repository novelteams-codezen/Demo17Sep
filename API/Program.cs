...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Demo17Sep", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<Demo17SepContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Demo17Sep API v1");
